        ...
        <section>
            <div class="container">
                <div class="decription-block">
                    ...
                    <div class="decription">
                        <h1>Землетрус</h1>
                        <p> - це сейсмічні явища, які виникають унаслідок
                            раптових зміщень і розривів у корі й більш глибоких шарах Землі
                            або внаслідок вулканічних і обвальних явищ, коли на великі від-
                            стані передаються потужні хвилі</p>
                        <a href="/pages/earthquakeCalculator.php">Перейти до розрахунку</a>
